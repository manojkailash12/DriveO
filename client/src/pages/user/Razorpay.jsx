...
// Export functions properly for React Fast Refresh
...
const fetchLatestBooking = async (user_id, dispatch) => {
  try {
...
const displayRazorpay = async (values, navigate, dispatch) => {
  try {
...
export { loadScript, fetchLatestBooking, displayRazorpay };
